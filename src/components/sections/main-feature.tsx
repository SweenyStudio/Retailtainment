    ...
    >
      ...
      <div className="flex flex-col text-center items-center z-20 relative">
        ...
        <Image
          src={Gif600}
          alt="0 to 600m"
          className="border-y border-zinc-300 w-full sm:w-1/2 shadow-xl sm:rounded-full  "
        />
        <Container>
          <motion.div variants={bounceAnimation}>
...
function UspComponent() {
  ...
  return (
    ...
    >
      <div className="border-y md:border-y-0 flex flex-col md:grid md:grid-cols-3  border-zinc-700 divide-y md:divide-y-0 md:divide-x divide-zinc-700 mt-6">
        {Usps.map((usp, index) => (
          <motion.div
            key={index}
          ...
          >
            ...
            <div className="w-full flex flex-col justify-center">
              ...
              <p className="mt-4 text-start text-base tracking-normal leading-tight text-zinc-600">
                {usp.description}
              </p>
            </div>
          </motion.div>
      ...
      >
        <video
          ...
          preload="none"
          poster={Poster.src}
          className="w-full h-full rounded-3xl object-contain object-center border border-zinc-950"
          ref={videoRef}
        ></video>
